...
#     @http.route([
#         '''/shop2''',
#         '''/shop/page/<int:page>2''',
#         '''/shop/category/<model("product.public.category"):category>2''',
#         '''/shop/category/<model("product.public.category"):category>/page/<int:page>2'''
#     ], type='http', auth="public", website=True, sitemap=sitemap_shop)
#     def shop(self, page=0, category=None, search='', min_price=0.0, max_price=0.0, ppg=False, **post):
#         add_qty = int(post.get('add_qty', 1))
#         print(int(post.get('add_qty', 1)))  # youssefTT
#         try:
...
#         return request.render("website_sale.products_test", values)  # youssefstop
